...
import messi from "../../src/public/1.png"
...
//   const gridHelper = new GridHelper(20,40,'red',0xffffff)
...
.voice-assistant img::before {
  ...
  width: 100%;
  height: 100%;
  background-color: rgba(0, 123, 255, 0.5); /* 蓝色半透明背景 */
  border-radius: 50%;
  opacity: 0;
  transition: opacity 0.3s ease-in-out;
}

.voice-assistant img.recording::before {
  opacity: 1;
}
